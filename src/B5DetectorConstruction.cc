...
G4VPhysicalVolume* B5DetectorConstruction::Construct()
{
  ...
  auto leadSolid = G4Material::GetMaterial("G4_Pb");
  ...
  // first lead sheet
  //auto leadBox  = new G4Box("leadBox",1.*m,30.*cm,2.5*cm);
  //auto leadLogical = new G4LogicalVolume(leadBox,leadSolid,"leadLogical");
